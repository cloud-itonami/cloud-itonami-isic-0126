# Operator Quickstart — Oleaginous-Fruit Plantation Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0126** (`cloud-itonami-isic-0126`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0126.git
cd cloud-itonami-isic-0126
```
...
- Blueprint governor key: `oleaginous-operations-governor`
- Likely source path: `oleaginousops.governor.cljc`
