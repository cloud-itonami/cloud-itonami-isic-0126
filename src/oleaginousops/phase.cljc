(ns oleaginousops.phase
  "Phase gate for the oleaginous-fruit plantation operations coordinator
  rollout (0->3 maturity). Mirrors `berrynutops.phase`
  (cloud-itonami-isic-0125) in shape, adapted to this actor's simpler op
  ...
  Phase 1: supervised operation -- always-escalate ops
    (`oleaginousops.governor/always-escalate-ops`) escalate even when
  ...
  (:require [oleaginousops.governor :as governor]))
